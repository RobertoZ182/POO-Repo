...
public:
    ...
    string getTip() const { return tip; } // membru const -> doar getter
...
int main()
{
    ...
    cout << "Pret Pizza dupa aplicare reducere 10% (aplicata prin functie prietena): " << m2.getPret() << " lei\n\n";
    ...
    for (auto &ing : m3.getIngrediente()) cout << ing << " ";
    cout << "\n\n";
    ...
    cout << "Valoare comanda o3 dupa aplicare TVA 9% (functie prietena): " << o3.getValoareTotala() << " lei\n\n";
    ...
    cout << "Dupa setDenumire(m2): m2.denumire = " << m2.getDenumire() << " | m2copy.denumire = " << m2copy.getDenumire() << "\n";

    o3.setValoareTotala(300.0f);
    cout << "Dupa setValoareTotala(o3): o3 = " << o3.getValoareTotala() << " | o3copy = " << o3copy.getValoareTotala() << "\n\n";

    cout << "=== Sfarsit testare ===\n";
    return 0;
}
